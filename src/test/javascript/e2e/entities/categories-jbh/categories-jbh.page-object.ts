...
export class CategoriesUpdatePage {
    ...
    userGroupCategoriesSelectLastOption(): promise.Promise<void> {
    ...
    userGroupCategoriesSelectOption(option): promise.Promise<void> {
        return this.userGroupCategoriesSelect.sendKeys(option);
    }
    ...
    getUserGroupCategoriesSelectedOption() {
